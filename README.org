...
* F' Questions
** General Overview
1. What is are the overarching goals of F' ?
   + What are the driving values/guiding principals that inform decisions about the underlying technologies or the frameworks architecture
